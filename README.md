...
[![Build Status](https://travis-ci.org/emilisr/kubewatch.svg?branch=master)](https://travis-ci.org/emilisr/kubewatch) [![Go Report Card](https://goreportcard.com/badge/github.com/emilisr/kubewatch)](https://goreportcard.com/report/github.com/emilisr/kubewatch) [![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://github.com/emilisr/kubewatch/blob/master/LICENSE)
...
In order to run kubewatch in a Kubernetes cluster quickly, the easiest way is for you to create a [ConfigMap](https://github.com/emilisr/kubewatch/blob/master/kubewatch-configmap.yaml) to hold kubewatch configuration.

An example is provided at [`kubewatch-configmap.yaml`](https://github.com/emilisr/kubewatch/blob/master/kubewatch-configmap.yaml), do not forget to update your own slack channel and token parameters. Alternatively, you could use secrets.
...
Create the [Pod](https://github.com/emilisr/kubewatch/blob/master/kubewatch.yaml) directly, or create your own deployment:
...
$ go get -u github.com/emilisr/kubewatch
...
```
$ mkdir -p $GOPATH/src/github.com/emilisr/
$ cd $GOPATH/src/github.com/emilisr/
$ git clone https://github.com/emilisr/kubewatch.git
$ cd kubewatch
